...
heuristic(state(w,w,w,b,b,b,e), state(w,w,w,b,b,b,e), 0).


heuristic(state(b,b,b,e,_,_,_), state(w,w,w,b,b,b,e), 6).
heuristic(state(b,b,w,e,_,_,_), state(w,w,w,b,b,b,e), 4).
heuristic(state(b,w,b,e,_,_,_), state(w,w,w,b,b,b,e), 4).
heuristic(state(w,b,b,e,_,_,_), state(w,w,w,b,b,b,e), 4).

heuristic(state(w,b,w,e,_,_,_), state(w,w,w,b,b,b,e), 1).
heuristic(state(b,w,w,e,_,_,_), state(w,w,w,b,b,b,e), 1).
heuristic(state(w,w,b,e,_,_,_), state(w,w,w,b,b,b,e), 1).
heuristic(state(w,w,w,e,_,_,_), state(w,w,w,b,b,b,e), 0).



heuristic(state(_,_,_,_,e,w,w), state(w,w,w,b,b,b,e), 5).
heuristic(state(_,_,_,_,e,w,b), state(w,w,w,b,b,b,e), 3).
heuristic(state(_,_,_,_,e,b,w), state(w,w,w,b,b,b,e), 3).
heuristic(state(_,_,_,_,e,b,b), state(w,w,w,b,b,b,e), 1).

heuristic(state(_,_,_,_,_,e,w), state(w,w,w,b,b,b,e), 4).
heuristic(state(_,_,_,_,_,e,b), state(w,w,w,b,b,b,e), 2).



heuristic(state(_,_,_,_,_,_,e), state(w,w,w,b,b,b,e), 3).

heuristic(state(b,b,e,_,_,_,_), state(w,w,w,b,b,b,e), 5).
heuristic(state(b,w,e,_,_,_,_), state(w,w,w,b,b,b,e), 3).
heuristic(state(w,b,e,_,_,_,_), state(w,w,w,b,b,b,e), 3).
heuristic(state(w,w,e,_,_,_,_), state(w,w,w,b,b,b,e), 1).


heuristic(state(b,e,_,_,_,_,_), state(w,w,w,b,b,b,e), 4).
heuristic(state(w,e,_,_,_,_,_), state(w,w,w,b,b,b,e), 2).


heuristic(state(e,_,_,_,_,_,_), state(w,w,w,b,b,b,e), 3).
